...
<body>
	<div class="col-10 m-auto">
		...
		<form action="/home/workingtime/find" method="POST">
			<div class="card">
				<div class="card-header text-uppercase font-weight-bold ">
					<i class="fas fa-list"></i> Working time
				</div>
				<br>
				...
				<div class="input-group mb-3 col-5">
					...
					<input type="time" class="form-control" placeholder="Name?"
						placeholder="Search" name="time1" value="${time1}"> <input
						type="time" class="form-control" placeholder="Name?"
						placeholder="Search" name="time2" value="${time2}">
